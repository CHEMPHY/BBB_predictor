 ...
 * @author Yi Hsiao
 */
public class BBB_predictorNodePlugin extends Plugin {
    // The shared instance.
    private static BBB_predictorNodePlugin plugin;

    /**
     * The constructor.
     */
    public BBB_predictorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BBB_predictorNodePlugin getDefault() {
        return plugin;
    }
